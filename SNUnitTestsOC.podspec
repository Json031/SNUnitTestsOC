#
#  Be sure to run `pod spec lint SNUnitTestsOC.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "http://github.com/Json031/SNUnitTestsOC"
  ...
  spec.source       = { :git => "http://github.com/Json031/SNUnitTestsOC.git", :tag => "#{spec.version}" }
